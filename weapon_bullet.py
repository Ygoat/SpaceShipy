...
class WeaponBullet():
    ...
    def __create(self,color:int=(100,200,100)) -> tuple[pygame.Rect,pygame.Rect]:
        ...
        hitbox_rect = pygame.draw.rect(self.hitbox_sur,(0,0,255),(0,0,self.radius*2*0.8,self.radius*2*0.8))
    ...
    def __init_hitbox_grobal_pos(self) -> tuple[float,float]:
        ...
        hitbox_grobal_x = self.ship_weapon.grobal_position_x_center - self.hitbox_sur.get_rect().centerx
        hitbox_grobal_y = self.ship_weapon.grobal_position_y_center - self.hitbox_sur.get_rect().centery
