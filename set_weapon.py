...
class SetWeapon():
    ...
    def __init__(self,screen:pygame.Surface,space_ship:SpaceShip):
        ...
        self.weapon_rec = self.__create_item(space_ship.shape,space_ship.weapon_pos[0])[2]
        # 初期位置にセット
    ...
    def __create_item(self,ship_shape:tuple[float,float],weapon_pos:tuple[float,float]) -> tuple[pygame.Surface,pygame.Rect,pygame.Rect]:
        size=(400,400)
