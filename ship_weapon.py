...
class ShipWeapon():
    ...
    def __init__(self,screen:pygame.Surface,space_ship:SpaceShip,weapon_id:int=0,pos_id:int=0) -> None:
        ...
        # 位置情報
        self.grobal_position_x:float = space_ship.grobal_pos_x + space_ship.weapon_pos[weapon_id][0] - self.sur.get_rect().centerx
        self.grobal_position_y:float = space_ship.grobal_pos_y + space_ship.weapon_pos[weapon_id][1] - self.sur.get_rect().centery
